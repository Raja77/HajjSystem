<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" MasterPageFile="~/HS/MainMaster.Master" CodeBehind="Residential_Block_Details.aspx.cs"
    Inherits="HajjSystem.Residential_Block_Details" %>
    ...
    <section id="fontSize" class="wrapper body-wrapper">
        <div class="bg-wrapper inner-wrapper">
            ...
            <div class="breadcam-bg breadcam">
                <div class="container common-container four_content">
                    <ul>
                        ...
                        <li class="current">Residential Block Details</li>
                    </ul>
                </div>
            </div>
            ...
            <section id="page-head" class="wrapper headings-wrapper">
                <div class="container common-container four_content">
                    <h1>Residential Block Details</h1>
                    <hr />
                </div>
            </section>
            <!--/#Page-Head-->
