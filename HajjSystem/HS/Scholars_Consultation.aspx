<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" MasterPageFile="~/HS/MainMaster.Master" CodeBehind="Scholars_Consultation.aspx.cs"
    Inherits="HajjSystem.Scholars_Consultation" %>
    ...
    <section id="fontSize" class="wrapper body-wrapper">
        <div class="bg-wrapper inner-wrapper">
            ...
            <div class="breadcam-bg breadcam">
                <div class="container common-container four_content">
                    <ul>
                        ...
                        <li class="current">Scholars Consultation Availablity</li>
                    </ul>
                </div>
            </div>
            ...
            <section id="page-head" class="wrapper headings-wrapper">
                <div class="container common-container four_content">
                    <h1>Scholars Consultation Availability</h1>
                    <hr />
                </div>
            </section>
            <!--/#Page-Head-->
