<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" MasterPageFile="~/HS/MainMaster.Master" CodeBehind="Haj_Group_Organizors.aspx.cs"
    Inherits="HajjSystem.Haj_Group_Organizors" %>
            ...
            <div class="breadcam-bg breadcam">
                <div class="container common-container four_content">
                    <ul>
                        ...
                        <li class="current">Haj Group Organizors</li>
                    </ul>
                </div>
            </div>
