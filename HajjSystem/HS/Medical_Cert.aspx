<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" MasterPageFile="~/HS/MainMaster.Master" CodeBehind="Medical_Cert.aspx.cs"
    Inherits="HajjSystem.Medical_Cert" %>
            ...
            <div class="breadcam-bg breadcam">
                <div class="container common-container four_content">
                    <ul>
                        ...
                        <li class="current">Medical Certificate</li>
                    </ul>
                </div>
            </div>
