<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" MasterPageFile="~/HS/MainMaster.Master" CodeBehind="History.aspx.cs"
    Inherits="HajjSystem.History" %>
    ...
    <section class="wrapper banner-wrapper">
        <div id="flexSlider" class="flexslider">
            <div class="inner-banner">
                <img src="theme/images/banner/IB1.jpg" alt="Inner Banner of Consumer Affairs" title="banner"></div>
        </div>
    </section>
