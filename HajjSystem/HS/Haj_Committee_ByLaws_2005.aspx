<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" MasterPageFile="~/HS/MainMaster.Master" CodeBehind="Haj_Committee_ByLaws_2005.aspx.cs"
    Inherits="HajjSystem.Haj_Committee_ByLaws_2005" %>
    ...
    <section id="fontSize" class="wrapper body-wrapper">
        <div class="bg-wrapper inner-wrapper">
            ...
            <div class="breadcam-bg breadcam">
                <div class="container common-container four_content">
                    <ul>
                        ...
                        <li class="current">Haj Committee By Laws 2005</li>
                    </ul>
                </div>
            </div>
            ...
            <section id="page-head" class="wrapper headings-wrapper">
                <div class="container common-container four_content">
                    <h1>Haj Committee By Laws 2005</h1>
                    <hr />
                </div>
            </section>
            <!--/#Page-Head-->
