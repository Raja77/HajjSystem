<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" MasterPageFile="~/MainMaster.Master" CodeBehind="Default.aspx.cs" 
    Inherits="HajjSystem._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <section class="wrapper banner-wrapper">
         <div id="flexSlider" class="flexslider">
            <ul class="slides">
               <li><img id="banner1" src="theme/images/banner/slider-1.jpg" alt="Banner Image 1" title="Banner 1"></li>
               <li><img src="theme/images/banner/slider-1.jpg" alt="Banner Image 2" title="Banner 2"></li>
               <li> <img src="theme/images/banner/slider-1.jpg" alt="Banner Image 3" title="Banner 3"></li>
               <li> <img src="theme/images/banner/slider-1.jpg" alt="Banner Image 4" title="Banner 4"></li>
               <li> <img src="theme/images/banner/slider-1.jpg" alt="Banner Image 5" title="Banner 5"></li>
               <li> <img src="theme/images/banner/slider-1.jpg" alt="Banner Image 6" title="Banner 6"></li>
               <li> <img src="theme/images/banner/slider-1.jpg" alt="Banner Image 7" title="Banner 7"></li>
               <li> <img src="theme/images/banner/slider-1.jpg" alt="Banner Image 8" title="Banner 8"></li>
            </ul>
         </div>
      </section>
